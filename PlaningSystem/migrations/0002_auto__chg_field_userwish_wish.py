...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserWish.wish'
        db.alter_column('PlaningSystem_userwish', 'wish_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PlaningSystem.WishEnum'], null=True))

    def backwards(self, orm):

        # Changing field 'UserWish.wish'
        db.alter_column('PlaningSystem_userwish', 'wish_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['PlaningSystem.WishEnum'], default=''))
