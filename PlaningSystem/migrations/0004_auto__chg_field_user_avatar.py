...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('PlaningSystem_user', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=1000, null=True))

    def backwards(self, orm):

        # Changing field 'User.avatar'
        db.alter_column('PlaningSystem_user', 'avatar', self.gf('django.db.models.fields.files.ImageField')(max_length=1000, default=''))
    ...
    models = {
        ...
        'PlaningSystem.user': {
            ...
            'avatar': ('django.db.models.fields.files.ImageField', [], {'max_length': '1000', 'blank': 'True', 'default': "''", 'null': 'True'}),
            ...
            'workplaces': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'default': "''", 'null': 'True', 'to': "orm['PlaningSystem.Workplace']"})
        },
